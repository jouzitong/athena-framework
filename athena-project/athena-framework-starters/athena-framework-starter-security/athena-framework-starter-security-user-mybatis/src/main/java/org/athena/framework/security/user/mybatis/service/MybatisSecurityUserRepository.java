 ...
 */
public class MybatisSecurityUserRepository implements SecurityUserRepository {

    private static final String CREDENTIAL_TYPE_PASSWORD = "PASSWORD";

    private final SecUserMybatisMapper userRepository;

    private final SecUserCredentialMybatisMapper credentialRepository;

    public MybatisSecurityUserRepository(SecUserMybatisMapper userRepository,
                                     SecUserCredentialMybatisMapper credentialRepository) {
