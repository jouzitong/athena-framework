...
public class MybatisRoleProvider implements RoleProvider {

    private final SecUserRoleMybatisMapper userRoleRepository;

    private final SecRoleMybatisMapper roleRepository;

    public MybatisRoleProvider(SecUserRoleMybatisMapper userRoleRepository,
                           SecRoleMybatisMapper roleRepository) {
