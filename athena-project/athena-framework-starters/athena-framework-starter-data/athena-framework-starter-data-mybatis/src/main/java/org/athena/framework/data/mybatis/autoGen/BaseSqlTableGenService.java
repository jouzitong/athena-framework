...
//        String updateTableDdlStr = filePath + "/update_table_ddl.sql";
        ...
        String createTableDdlFileStr = filePath + "/" + version + "/create_table_ddl.sql";
        String updateTableDdlStr = filePath + "/" + version + "/update_table_ddl.sql";

        LOGGER.info("生成表结构目录: {}", (filePath + "/" + version));
