...
import org.arthena.common.base.ExtensibleProperties;
 ...
 *
 * @author zhouzhitong
 * @see org.authena.mybatis.utils.MybatisPlusWrapperUtils 用于构建查询条件
 */
@Data
...
public class BaseRequest extends ExtensibleProperties implements Serializable {
     ...
     *
     * @see org.authena.mybatis.utils.MybatisPlusWrapperUtils MybatisWrapperUtils
     */
